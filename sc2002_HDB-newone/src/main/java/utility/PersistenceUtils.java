...
public class PersistenceUtils {
    ...
    private static final String USER_FILE = "sc2002_HDB-newone/src/main/resources/users.csv";
    private static final String PROJECT_FILE = "sc2002_HDB-newone/src/main/resources/projectList.csv";
    private static final String APPLICATION_FILE = "sc2002_HDB-newone/src/main/resources/applications.csv";
    private static final String ENQUIRY_FILE = "sc2002_HDB-newone/src/main/resources/enquiries.csv";
    private static final String REGISTRATION_FILE = "sc2002_HDB-newone/src/main/resources/registrations.csv";
    ...
    public static void saveUsers(List<User> users, String ExcelName) {
        ...
        File dir = new File("sc2002_HDB-newone/src/main/resources");
        if (!dir.exists()) {
            dir.mkdirs();
        }
