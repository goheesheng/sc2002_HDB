...
public class Project {
    ...
    public Project(String projectId, String projectName, String neighborhood, 
        ...
        this.availableOfficerSlots = Math.min(availableOfficerSlots, 10);
    ...
    public String toString() {
        ...
        for (Map.Entry<FlatType, Integer> entry : flatTypes.entrySet()) {
            flatTypesString.append(entry.getKey()).append(": ").append(entry.getValue()).append(", ");
        }
        // Remove the trailing comma and space
        if (flatTypesString.length() > 0) {
            flatTypesString.setLength(flatTypesString.length() - 2);
        }
    
        return projectId + ". " + projectName + " - " + flatTypesString.toString();
    }
