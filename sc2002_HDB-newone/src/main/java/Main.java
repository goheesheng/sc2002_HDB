...
public class Main {
    ...
    private static void processExcelFilesAndExportCSV() {
        ...
        String[] userExcelPaths = {
            "sc2002_HDB-newone/src/main/resources/ApplicantList.xlsx",
            "sc2002_HDB-newone/src/main/resources/ManagerList.xlsx",
            "sc2002_HDB-newone/src/main/resources/OfficerList.xlsx"
        };
        ...
        String projectExcelPath = "sc2002_HDB-newone/src/main/resources/ProjectList.xlsx";
    ...
    public static void runTestCases() {
        ...
        // Get current flat count and update it
        int currentCount = project.getRemainingFlats(FlatType.TWO_ROOM);
        boolean updatedFlats = officer1.updateRemainingFlats(FlatType.TWO_ROOM, currentCount - 1);
